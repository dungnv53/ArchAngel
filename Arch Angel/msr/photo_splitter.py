...
01.09.2011  -   Added file chooser dialog
...
class Application(Tkinter.Frame):              
    ...
    def loadimage(self):
        ...
        if self.image.mode == 'I':   # cannot display more than 8bits per channel
            I_to_L_conversiontable = [i/256 for i in range(65536)]
            self.image_thumb = self.image.point(I_to_L_conversiontable,'L')
        else:

...
public class d
{
  ...
  public Image b(int paramInt)
  {
    ...
    try
    {
      ...
      {
        this.c.close();
        this.c = super.getClass().getResourceAsStream(this.f);
  ...
  public int c()
    throws Exception  // Ham c nay de giai ma anh .png da them 24byte ? o dau.
    // H sau khi HexEdit -> ko can nhung du sao ham nay cung hay nen giu lai.
    // Co the dung ngay khi trong Android ? cool ?
    /*
    * Kha nang viec shift byte la do Img Compress chu ko fai do encode media ?
    */
  {
    int i = 0;
  ...
  public void a(string paramstring)
  {
    ...
    try
    {
      this.c = super.getclass().getresourceasstream(paramstring);
      int i = c() + 1;
      this.d = new int[i];
      for (int j = 0; j < i; ++j)
        this.d[j] = c();

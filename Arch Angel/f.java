...
public class f
{
  ...
  public void a(g paramg, int paramInt)
  {
    ...
    paramg.b += paramg.i;
    int i3;
    label353: label484: label504: int i1;
    switch (i2)
    {
    case 9:
      if (this.aa == 1)
    ...
    case 8:
      ...
      break;
    case 7:
      label542: label718: label893: if (paramg.l > 0)
        break label1227;
      label1067: this.ag += -1;
      label1160: paramg.c = 0;
      this.t += 1;
      this.a.ab = 6;
  ...
  public void c(Graphics paramGraphics)
  {
    ...
    this.b.a(paramGraphics, 7, this.a5[0] + ((this.a7[0] != 0) ? -240 : 240), 27);
  ...
  public void d(Graphics paramGraphics)
  {
    ...
    for (int i1 = 0; i1 < 3; ++i1)
    {
      ...
      this.b.b(paramGraphics, 9 + i1 * 3 + i2, this.a5[(i1 + 2)] + ((this.a7[(i1 + 1)] != 0) ? -240 : 240), this.a6[i1] - arrayOfInt[i1][i2]);
    }
  ...
  public int b(g paramg, int paramInt)
  {
    ...
    paramg.h = (this.al - this.an + b(i4 -= 360));
  ...
  public void b(Graphics paramGraphics, g paramg)
  {
    ...
    case 7:
    case 8:
      label642: a(paramGraphics, true, i2 + 88 + 32, 158 - i3, i4 * 4 + 2, i4 + 1, i4 + 1);
      break;
    case 5:
      label145: label182: label508: a(paramGraphics, true, i2 + 88 + 32, 158 - i3, i4 * 4 + 2, i4 + 1, i4 + 1);
    case 2:
    case 3:
    }
  }
